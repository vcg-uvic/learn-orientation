...
# Version:
# Package-Requires: ()
# Last-Updated: Mon Jul  4 06:01:40 2016 (-0700)
#           By: Kwang Moo Yi
#     Update #: 38
# URL:
# Doc URL:
...
class CustomArcTan2(theano.scalar.basic.BinaryScalarOp):
    ...
    def grad(self, inputs, gout):
        ...
        if gz.type in complex_types:
            ...
            return [
                gz * x / (sqr(x) + sqr(y) + numpy.cast[x.type](1e-15)),
                gz * neg(y) / (sqr(x) + sqr(y) + numpy.cast[x.type](1e-15))
            ]
...
# alias
custom_arctan2 = CustomArcTan2(
    theano.scalar.basic.upgrade_to_float, name='custom_arctan2')
